...
$peliculas = array(
    ...
    "comunidad-del-anillo.jpg", "sexto-
    sentido.jpg","Avengers.jpg","Parasite.jpg"
);
...
<form action="pagoentrada.php" method="POST">
    <fieldset class="form-group">
        ...
        <input class="form-control" type="text" name="cantidad" id="cantidad" maxlength="1" placeholder="Cantidad" pattern="\d{1}"required />
        <br/>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data- ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="<?php echo $dir."/".$peliculas[$claves[0]]; ?>" />
            <br />
            </div>
