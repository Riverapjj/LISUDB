...
<body>
    ...
    <section>
        <div class="container">
            <?php
                /*La función espera una matriz con una lista ($lista) ya sea de países o ciudades y un parámetro opcional con el tipo de lista que tendrá un valor por defecto "ul"*/
                    ...
                    switch ($tipo):
                        case "ul":
                            ...
                            foreach ($lista as $key => $value):
                                $ullist .= "\t\t<li><a ref=\"javascript:void(0)\">$key => $value</a></li>\n";
                            endforeach;
